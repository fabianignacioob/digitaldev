...
class Application extends BaseApplication
{
    ...
    public function middleware(MiddlewareQueue $middlewareQueue): MiddlewareQueue
    {
        ...
        // Transbank returns with POST in some cancellation scenarios. The token
        // is checked against the stored payment before any state is changed.
        $csrf->skipCheckCallback(static function (ServerRequestInterface $request): bool {
            return $request->getUri()->getPath() === '/payments/webpay/return';
        });
