  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .brand img { display: block; width: 54px; height: 54px; border: 1px solid rgba(243, 107, 22, 0.25); border-radius: 50%; background: #fff; object-fit: cover; }
      .nav-toggle {
        display: none;
        width: 42px;
        height: 42px;
      ...
      .nav-links a:hover, .nav-links a:focus-visible { color: var(--catops-orange); }
      .nav-links .nav-cta {
        margin-left: 6px;
        padding: 0 15px;
        border-radius: 8px;
      ...
      .nav-links .nav-cta:hover, .nav-links .nav-cta:focus-visible { background: #d9570d; color: #fff; }

      .hero { padding: clamp(48px, 7vw, 92px) 0 56px; background: linear-gradient(135deg, #f2f9ff 0%, #fff9f3 56%, #f5fffb 100%); }
      ...
      .hero h1 { max-width: 670px; font-size: clamp(38px, 5vw, 64px); line-height: 1.02; font-weight: 800; }
      .hero-copy { max-width: 645px; margin-top: 18px; font-size: 18px; }
      ...
      .button:hover, .button:focus-visible { background: #d9570d; color: #fff; transform: translateY(-1px); }
      .button-secondary { border-color: #b8c9d7; background: #fff; color: var(--catops-blue); box-shadow: none; }
      .button-secondary:hover, .button-secondary:focus-visible { background: var(--soft-blue); color: var(--catops-blue); }
      .support-line { margin-top: 18px; color: #52616c; font-size: 14px; font-weight: 700; }
      .hero-product {
        position: relative;
        overflow: hidden;
        padding: 12px;
      ...
      .hero-product img { display: block; width: 100%; border-radius: 8px; }
      .hero-caption {
        position: absolute;
        right: 26px;
        bottom: 26px;
      ...
      .section-tint { background: linear-gradient(180deg, var(--soft-blue), #fff); }
      .section-head { max-width: 720px; margin: 0 auto 32px; text-align: center; }
      .section-head h2 { font-size: clamp(28px, 3.6vw, 46px); line-height: 1.1; font-weight: 800; }
      ...
      .card h3 { margin-bottom: 10px; font-size: 20px; font-weight: 800; }
      .icon-number {
        display: inline-grid;
        width: 34px;
        height: 34px;
      ...
      .type-card .type-label { color: var(--catops-orange); font-size: 13px; font-weight: 800; }
      .type-card .type-link { margin-top: auto; padding-top: 16px; color: var(--catops-blue); font-weight: 800; text-decoration: none; }
      .type-card .type-link:hover { color: var(--catops-orange); }
      .steps { counter-reset: step; }
      .step { position: relative; padding-left: 58px; }
      .step::before { content: counter(step); counter-increment: step; position: absolute; top: 22px; left: 22px; display: grid; width: 24px; height: 24px; place-items: center; border-radius: 50%; background: var(--catops-blue); color: #fff; font-size: 13px; font-weight: 800; }
      .check-list { display: grid; gap: 12px; margin: 0; padding: 0; list-style: none; }
      .check-list li { position: relative; padding-left: 26px; color: #35434f; font-weight: 700; line-height: 1.5; }
      .check-list li::before { content: "✓"; position: absolute; left: 0; color: var(--catops-orange); font-weight: 900; }

      .demo-layout { display: grid; gap: 26px; align-items: center; }
      .demo-media { padding: 10px; border: 1px solid var(--line); border-radius: 12px; background: #fff; box-shadow: var(--shadow); }
      .demo-media img { display: block; width: 100%; border-radius: 7px; }
      .demo-copy h2 { font-size: clamp(28px, 3.4vw, 42px); font-weight: 800; }
      .demo-copy p { margin-top: 14px; }
      .demo-note { padding: 14px; border-left: 3px solid var(--catops-orange); background: var(--soft-orange); color: #4d3a2f; font-size: 14px; line-height: 1.55; }
      ...
      .trust-item { padding: 18px; border-radius: 8px; background: var(--soft-mint); color: #25473d; font-weight: 700; }
      .faq-list { max-width: 850px; margin: 0 auto; }
      .faq-list details { border-bottom: 1px solid var(--line); }
      .faq-list summary { padding: 18px 4px; color: var(--ink); font-weight: 800; cursor: pointer; }
      .faq-list p { padding: 0 4px 18px; }
      .final-cta { background: linear-gradient(135deg, var(--catops-blue), #164c98); color: #fff; text-align: center; }
      .final-cta h2 { color: #fff; font-size: clamp(30px, 4vw, 48px); font-weight: 800; }
      .final-cta p { max-width: 650px; margin: 14px auto 0; color: rgba(255,255,255,0.86); }
      .final-cta .actions { justify-content: center; }
      .final-cta .button-secondary { border-color: rgba(255,255,255,0.75); background: #fff; color: var(--catops-blue); }
      ...
      .footer-links a:hover { color: var(--catops-orange); }
      ...
      @media (max-width: 520px) {
        ...
        .hero-caption { right: 20px; bottom: 20px; max-width: 185px; }
        .actions .button { width: 100%; }
        .nav-wrap.is-open .nav-links { grid-template-columns: 1fr; }
      }
    </style>
  </head>
  <body>
    ...
    <main>
      <section class="hero" id="inicio">
        <div class="container hero-grid">
          ...
          <div class="hero-product">
            <img src="/img/responsive2.png" alt="CatOps mostrado en notebook, celular y tablet">
      ...
      <section class="section-soft" id="problema">
        <div class="container">
          ...
          <div class="grid three">
            <article class="card"><span class="icon-number">1</span><h3>Todo ordenado</h3><p>Productos, servicios, precios, imágenes y contacto en un lugar fácil de revisar.</p></article>
            <article class="card"><span class="icon-number">2</span><h3>Siempre actualizado</h3><p>Cambia un precio, agrega una foto o edita un servicio desde tu panel cuando lo necesites.</p></article>
            <article class="card"><span class="icon-number">3</span><h3>Fácil de compartir</h3><p>Envía el mismo enlace por WhatsApp, Instagram, bio, QR o redes sociales.</p></article>
          </div>
        </div>
      </section>
      ...
      <section class="section-soft" id="como-funciona">
        <div class="container">
          ...
          <div class="grid three steps">
            <article class="card step"><h3>Elige el tipo de sitio</h3><p>Parte con una carta digital, catálogo de productos o catálogo de servicios.</p></article>
            <article class="card step"><h3>Agrega tu contenido</h3><p>Sube tu logo, fotos, productos, precios, descripciones y datos de contacto.</p></article>
            <article class="card step"><h3>Publica y comparte</h3><p>Activa tu enlace y compártelo donde tus clientes ya te encuentran.</p></article>
          </div>
        </div>
      </section>
      ...
      <section class="section-tint" id="beneficios">
        <div class="container">
          <div class="section-head"><h2>Hecho para el día a día de un negocio pequeño</h2><p>Lo importante es que tu información esté clara, disponible y sea fácil de mantener.</p></div>
          <div class="grid three">
            <article class="card"><ul class="check-list"><li>No necesitas programación.</li><li>Funciona en celulares.</li></ul></article>
            <article class="card"><ul class="check-list"><li>Actualizas desde tu panel.</li><li>Compartes un solo enlace.</li></ul></article>
            <article class="card"><ul class="check-list"><li>Recibes consultas por WhatsApp.</li><li>Mantienes precios y servicios al día.</li></ul></article>
          </div>
        </div>
      </section>
      ...
      <section class="section-tint" id="preguntas">
        <div class="container">
          <div class="section-head"><h2>Preguntas frecuentes</h2><p>Lo esencial antes de crear tu sitio.</p></div>
          <div class="faq-list">
            ...
            <details><summary>¿Puedo actualizar mis productos o servicios?</summary><p>Sí. Puedes mantener precios, descripciones, fotos y disponibilidad de contenido desde tu panel.</p></details>
            <details><summary>¿Puedo usar mi propio dominio?</summary><p>Puedes comenzar con un subdominio de CatOps. La conexión de un dominio propio se revisa y configura antes de activarla; no se realiza automáticamente hoy.</p></details>
            ...
            <details><summary>¿Incluye carrito o compras online?</summary><p>No. CatOps está pensado para mostrar tu oferta y recibir consultas por WhatsApp; no incluye carrito ni pagos en línea para clientes finales.</p></details>
            <details><summary>¿Cómo funciona la renovación?</summary><p>La suscripción cubre períodos mensuales y se renueva después de la confirmación del pago. No existen cobros automáticos.</p></details>
            <details><summary>¿Qué pasa si necesito ayuda?</summary><p>Puedes contactarnos para resolver dudas sobre la configuración y el uso de tu sitio.</p></details>
          </div>
        </div>
      </section>
