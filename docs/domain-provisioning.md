...
Contenido de sudoers, ajustando el usuario FPM:
...
```
*/5 * * * * cd /var/www/catops/current && /usr/bin/php bin/cake domains provision --limit=20 >> /var/log/catops/domains-provision.log 2>&1
```
