...
return [
    ...
    /*
     * Webpay Plus reads all credentials from the environment. Keep production
     * credentials outside the repository, normally in the host secret store.
     */
    'Payments' => [
        'webpay' => [
    ...
    'Session' => [
        ...
        'ini' => [
            ...
            'session.cookie_secure' => !filter_var(env('DEBUG', false), FILTER_VALIDATE_BOOLEAN),
        ],
    ],
